...
INSERT INTO products (category_id, brand, name, description, price, stock_quantity, image_url) VALUES
(1, 'Calvin Klein', 'CK One', 'Classic fresh unisex scent', 65.00, 40, '/images/ck_one.png');
INSERT INTO products (category_id, brand, name, description, price, stock_quantity, image_url) VALUES
(3, 'MAC', 'Studio Fix Foundation', 'Full coverage foundation', 35.00, 50, '/images/studio_fix.jpg');
INSERT INTO products (category_id, brand, name, description, price, stock_quantity, image_url) VALUES
(3, 'NYX', 'Concealer', 'Full coverage concealer', 12.00, 75, '/images/nyx_conc.jpg');
INSERT INTO products (category_id, brand, name, description, price, stock_quantity, image_url) VALUES
(4, 'Urban Decay', 'Naked Palette', 'Neutral eyeshadow palette', 54.00, 30, '/images/naked.jpg');
INSERT INTO products (category_id, brand, name, description, price, stock_quantity, image_url) VALUES
(4, 'Maybelline', 'Sky High Mascara', 'Lengthening mascara', 14.00, 60, '/images/sky_high.png');
INSERT INTO products (category_id, brand, name, description, price, stock_quantity, image_url) VALUES
(5, 'MAC', 'Ruby Woo', 'Classic red lipstick', 22.00, 45, '/images/ruby_woo.jpg');
INSERT INTO products (category_id, brand, name, description, price, stock_quantity, image_url) VALUES
(5, 'NYX', 'Butter Gloss', 'Sheer lip gloss', 8.00, 80, '/images/butter.jpg');
